        ...
        for subj in range(subject_start, 20):
            ...
            for epoch in range(0, num_epochs):
                ...
                if (epoch + 1) % 10 == 0 or epoch + 1 == 1:
                    ...
                    features_UMAP_train = features_umap_ALL[0 : feat_train_fnirs.shape[0], :]
                    features_UMAP_val = features_umap_ALL[feat_train_fnirs.shape[0] : feat_train_fnirs.shape[0] + feat_val_fnirs.shape[0], :]
                    features_UMAP_test = features_umap_ALL[feat_train_fnirs.shape[0] + feat_val_fnirs.shape[0] : feat_train_fnirs.shape[0] + feat_val_fnirs.shape[0] + feat_test_fnirs.shape[0], :]
